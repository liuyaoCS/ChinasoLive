...
public class MutlLiveActivity extends Activity {
	...
	private static String Defualt_ActivityID = "";// "201412083000001";
...
//			this.mPlayerView.pauseVideo();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//mPlayerView = new MyMultLivePlayCenter(this, false,true,480,960,3);
...
//		View playView=this.mPlayerView.getPlayerView();
//		playView.setClickable(false);
//		int num=((ViewGroup)playView).getChildCount();
//		for(int i=0;i<num;i++){
//			View child=((ViewGroup)playView).getChildAt(i);
//			Log.i("ly", "child " + i + " height,width=" + child.getHeight()+","+child.getWidth());
//		}
